...
$_ENV['invite_gift']                = 1;            //邀请新用户获得流量奖励，单位G
...
//支付系统设置----------------------------------------------------------------------------------------
#取值 none | codepay | f2fpay paymentwall | spay | payjs | yftpay
...
$_ENV['detect_gfw_url']                  = 'https://tool.chinaz.com/iframe.ashx?t=port';    //检测节点是否被gfw墙了的API的URL
