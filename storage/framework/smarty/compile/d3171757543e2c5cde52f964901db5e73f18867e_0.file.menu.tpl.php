<?php
/* Smarty version 3.1.48, created on 2023-06-21 15:15:56
  from '/www/wwwroot/SSPanel/resources/views/metron/include/global/menu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_6492a3ac99de47_93322989',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd3171757543e2c5cde52f964901db5e73f18867e' => 
    array (
      0 => '/www/wwwroot/SSPanel/resources/views/metron/include/global/menu.tpl',
      1 => 1687331752,
      2 => 'file',
    ),
  ),
...
function content_6492a3ac99de47_93322989 (Smarty_Internal_Template $_smarty_tpl) {
                                        ...
                                        <ul class="menu-nav">
                                            <li class="menu-item menu-item-submenu menu-item-rel">
                                                <a href="/user" class="menu-link">
                                                   <i class="fab fa-fort-awesome"></i> <span class="menu-text"><strong>首页</strong></span>
                                                </a>
                                            </li>
                                            <li class="menu-item menu-item-submenu menu-item-rel">
                                            ...
                                            <li class="menu-item menu-item-submenu menu-item-rel">
                                                <a href="/user/ticket" class="menu-link">
                                                    <i class="fas fa-headset"></i><span class="menu-text"><strong>工单支持</strong></span>
                                                </a>
                                            </li>
                                            <?php }?>
                                            <li class="menu-item menu-item-submenu menu-item-rel">
                                                <a href="/user/help" class="menu-link">
                                                    <i class="fas fa-book"></i><span class="menu-text"><strong>使用教程</strong></span>
                                                </a>
                                            </li>
                                            ...
                                            <li class="menu-item menu-item-submenu menu-item-rel">
                                                <a href="/admin" class="menu-link">
                                                    <i class="far flaticon2-settings" /></i><span class="menu-text"><strong>管理面板</strong></span>
                                                </a>
                                            </li>
                                            <?php }?>
