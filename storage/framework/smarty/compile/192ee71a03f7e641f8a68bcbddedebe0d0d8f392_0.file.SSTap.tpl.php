<?php
/* Smarty version 3.1.48, created on 2023-06-21 14:55:25
  from '/www/wwwroot/SSPanel/resources/views/metron/user/tutorial/Windows/SSTap.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_64929edda9ff12_25979934',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '192ee71a03f7e641f8a68bcbddedebe0d0d8f392' => 
    array (
      0 => '/www/wwwroot/SSPanel/resources/views/metron/user/tutorial/Windows/SSTap.tpl',
      1 => 1686149747,
      2 => 'file',
    ),
  ),
...
function content_64929edda9ff12_25979934 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
    <head>
        <title>SSTap 使用教程 &mdash; <?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
</title>
...
/media/tutorial/windows/sstap/sstap.jpg" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url'];?>
/media/tutorial/windows/sstap/sstap.jpg"/></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <a href="<?php echo $_smarty_tpl->tpl_vars['metron']->value['client_windows']['sstap']['down'];?>
" class="btn btn-pill btn-sstap mb-4" target="_blank">&nbsp;&nbsp;<i class="metron-sstap text-white"></i>下载 SSTap 客户端</a>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url'];?>
/media/tutorial/windows/sstap/2018020309355115.png" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url'];?>
/media/tutorial/windows/sstap/2018020309355115.png"/></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <div class="btn-group mb-3 mr-3">
                                                            <button type="button" class="btn btn-pill btn-sstap copy-text" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value["ssr"];?>
">&nbsp;&nbsp;<i class="metron-ssr1 text-white"></i>复制 SSTap 订阅&nbsp;&nbsp;</button>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url'];?>
/media/tutorial/windows/sstap/20200330195059.png" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url'];?>
/media/tutorial/windows/sstap/20200330195059.png"/></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row p-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url'];?>
/media/tutorial/windows/sstap/20200330195447.jpg" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url'];?>
/media/tutorial/windows/sstap/20200330195447.jpg"/></a>
                                                    </div>
                                                </div>
